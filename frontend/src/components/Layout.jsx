        ...
        <Disclosure as="nav" className="bg-white shadow-sm">
          {({ open }) => (
            <>
                ...
                <div className="flex h-16 justify-between">
                      ...
                      {navigation.map((item) => (
                        <Link
                          ...
                          item.current
                            ...
                            'group flex items-center gap-x-3 rounded-md p-2 text-xs leading-6 font-semibold'
                          )}
                        >
                          <item.icon
                            className={clsx(
                  ...
                  <div className="hidden sm:ml-6 sm:flex sm:items-center">
                    <button
                      ...
                      onClick={() => {window.open('https://bibohealth.com/wp-admin/index.php', '_blank')}}
                    >
                      <span className="absolute -inset-1.5" />
                      <span className="sr-only">Open Wordpress</span>
                      <BiLogoWordpress className="h-8 w-8" aria-hidden="true" />
                    </button>
              ...
              {/* mobile menu */}
              <Disclosure.Panel className="sm:hidden w-[90%] mx-auto sticky bg-white rounded-lg ring-1 ring-gray-100">
                  ...
                  {navigation.map((item) => (
                    <Disclosure.Button
                      ...
                      className={classNames(
                        ...
                        'block border-l-4 py-2 pl-3 pr-4 font-medium text-sm'
                      )}
                  ...
                  <div className="mt-3 space-y-1">
                    {userNavigation.map((item) => (
                      <Disclosure.Button
                        ...
                        as="a"
                        href={item.href}
                        className="block px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800"
                      >
                        {item.name}
                      </Disclosure.Button>
                    ))}
